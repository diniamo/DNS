...
import me.diniamo.commands.`fun`.ThisCreatureDoesNotExist
...
fun main() {
    ...
    client.addCommands(Help(client), Ping(), Emote(), Eval(client), Translate(), Google(), Uptime(), Info(), Color(), EchoCommand(), Urban(), Test(), ThisCreatureDoesNotExist())
